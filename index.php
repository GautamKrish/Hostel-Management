...
$stmt=$mysqli->prepare("SELECT email,password,id FROM hostelite WHERE email=? and password=? ");
						...
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									...
									<input type="submit" name="login" class="btn btn-info btn-block" style="font-size:20px" value="Login" >
								</form>
							</div>
						</div>
