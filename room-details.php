	...
	<div class="ts-main-content">
		...
		<div class="content-wrapper">
			<div class="container-fluid">
				<div class="row">
					<div class="col-md-12">	
						<h2 class="page-title"style="padding:20px">Room Details</h2>
						<div class="panel panel-default">
							<div class="panel-heading"style="font-size:25px"><b>All Room Details</b></div>
...
<tr>
<td colspan="4"><h4><b>Room Related Info</b></h4></td>
